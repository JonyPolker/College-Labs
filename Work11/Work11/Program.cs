                ...
                switch (key)
                {
                    case 1:
                        ...
                        for (int i = 1; i <= 3; i++)
                        {
                            if (i == 1)
                            {
                                Console.WriteLine($"Денег в хранилище - {rs.DisplayResource(i)}");
                            }
                            else if (i == 2)
                            {
                                Console.WriteLine($"Дерева в хранилище - {rs.DisplayResource(i)}");
                            }
                            else if (i == 3)
                            {
                                Console.WriteLine($"Железа в хранилище - {rs.DisplayResource(i)}");
                            }
                        }
                        Stop();
                        break;
